...
class AboutUsTabletPage extends StatefulWidget {
  ...
  @override
  State<AboutUsTabletPage> createState() => _AboutUsTabletPageState();
}

class _AboutUsTabletPageState extends State<AboutUsTabletPage> {
  String aboutUs =
