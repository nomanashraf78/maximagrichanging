...
class AboutUsDesktopPage extends StatefulWidget {
  final Widget pageDrawer;
  const AboutUsDesktopPage({Key? key, required this.pageDrawer})
      : super(key: key);

  @override
  State<AboutUsDesktopPage> createState() => _AboutUsDesktopPageState();
}

class _AboutUsDesktopPageState extends State<AboutUsDesktopPage> {
  String aboutUs =
