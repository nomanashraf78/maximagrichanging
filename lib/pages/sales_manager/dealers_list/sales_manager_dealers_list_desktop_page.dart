...
class _SalesManagerDealersListDesktopPageState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sales Managers Dealers List'),
      ),
      body: Row(
        children: [
                          ...
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => Responsiveness(
                                mobilePage:
                                    SalesManagerUserOrdersListMobilePage(
                                        userType: userProfile.userType.toString(),
                                        userUID: userProfile.userUID),
                                tabletPage:
                                    SalesManagerUserOrdersListTabletPage(
                                        userType: userProfile.userType.toString(),
                                        userUID: userProfile.userUID),
                                desktopPage:
                                    SalesManagerUserOrdersListDesktopPage(
                                        userType: userProfile.userType.toString(),
                                        userUID: userProfile.userUID),
                              ),
                            ),
