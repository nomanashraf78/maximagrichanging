...
class SalesManagerUserOrdersListTabletPage extends StatefulWidget {
  final String userType;
  final String userUID;
  const SalesManagerUserOrdersListTabletPage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<SalesManagerUserOrdersListTabletPage> createState() =>
      _SalesManagerUserOrdersListTabletPageState();
}

class _SalesManagerUserOrdersListTabletPageState
    extends State<SalesManagerUserOrdersListTabletPage> {
  @override
