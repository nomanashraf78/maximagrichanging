...
class SalesManagerUserOrdersListMobilePage extends StatefulWidget {
  final String userType;
  final String userUID;
  const SalesManagerUserOrdersListMobilePage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<SalesManagerUserOrdersListMobilePage> createState() =>
      _SalesManagerUserOrdersListMobilePageState();
}

class _SalesManagerUserOrdersListMobilePageState
    extends State<SalesManagerUserOrdersListMobilePage> {
  @override
