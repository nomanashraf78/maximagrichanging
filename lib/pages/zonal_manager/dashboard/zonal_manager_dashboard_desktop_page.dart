                          ...
                          pageRoute: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => const Responsiveness(
                                mobilePage:
                                    ZonalManagerCreditCenterMobilePage(),
                                tabletPage:
                                    ZonalManagerCreditCenterTabletPage(),
                                desktopPage:
                                    ZonalManagerCreditCenterDesktopPage(),
                              ),
                            ),
                          ),
                        ),
                          ...
                          pageRoute: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => const Responsiveness(
                                ...
                                desktopPage:
                                    ZonalManagerDealersListDesktopPage(),
                              ),
                            ),
                          ),
                        ),
                          ...
                          pageRoute: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => const Responsiveness(
                                ...
                                desktopPage:
                                    ZonalManagerOrdersListDesktopPage(),
                              ),
                            ),
                          ),
                        ),
