...
class ZonalManagerUserOrdersListTabletPage extends StatefulWidget {
  final String userType;
  final String userUID;
  const ZonalManagerUserOrdersListTabletPage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<ZonalManagerUserOrdersListTabletPage> createState() =>
      _ZonalManagerUserOrdersListTabletPageState();
}

class _ZonalManagerUserOrdersListTabletPageState
    extends State<ZonalManagerUserOrdersListTabletPage> {
  @override
