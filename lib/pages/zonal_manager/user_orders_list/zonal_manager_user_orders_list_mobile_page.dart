...
class ZonalManagerUserOrdersListMobilePage extends StatefulWidget {
  final String userType;
  final String userUID;
  const ZonalManagerUserOrdersListMobilePage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<ZonalManagerUserOrdersListMobilePage> createState() =>
      _ZonalManagerUserOrdersListMobilePageState();
}

class _ZonalManagerUserOrdersListMobilePageState
    extends State<ZonalManagerUserOrdersListMobilePage> {
  @override
