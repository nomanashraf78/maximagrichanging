...
class ZonalManagerUserOrdersListDesktopPage extends StatefulWidget {
  final String userType;
  final String userUID;
  const ZonalManagerUserOrdersListDesktopPage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<ZonalManagerUserOrdersListDesktopPage> createState() =>
      _ZonalManagerUserOrdersListDesktopPageState();
}

class _ZonalManagerUserOrdersListDesktopPageState
    extends State<ZonalManagerUserOrdersListDesktopPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Zonal Manager User Orders List'),
      ),
      body: Row(
        children: [
