...
class OperationsUserOrdersListMobilePage extends StatefulWidget {
  final String userType;
  final String userUID;
  const OperationsUserOrdersListMobilePage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<OperationsUserOrdersListMobilePage> createState() =>
      _OperationsUserOrdersListMobilePageState();
}

class _OperationsUserOrdersListMobilePageState
    extends State<OperationsUserOrdersListMobilePage> {
  @override
