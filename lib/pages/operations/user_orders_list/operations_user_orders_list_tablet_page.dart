...
class OperationsUserOrdersListTabletPage extends StatefulWidget {
  final String userType;
  final String userUID;
  const OperationsUserOrdersListTabletPage(
      {Key? key, required this.userType, required this.userUID})
      : super(key: key);

  @override
  State<OperationsUserOrdersListTabletPage> createState() =>
      _OperationsUserOrdersListTabletPageState();
}

class _OperationsUserOrdersListTabletPageState
    extends State<OperationsUserOrdersListTabletPage> {
  @override
                        ...
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => Responsiveness(
                              ...
                              desktopPage: OperationsOrderDetailsDesktopPage(
                                orderDetails: orderInfo,
                                orderDocID: orderDocID,
                              ),
                            ),
