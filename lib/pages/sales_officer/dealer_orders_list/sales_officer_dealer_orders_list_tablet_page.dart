...
class SalesOfficerDealerOrdersListTabletPage extends StatefulWidget {
  final String dealerUID;
  const SalesOfficerDealerOrdersListTabletPage(
      {Key? key, required this.dealerUID})
      : super(key: key);

  @override
  State<SalesOfficerDealerOrdersListTabletPage> createState() =>
      _SalesOfficerDealerOrdersListTabletPageState();
}

class _SalesOfficerDealerOrdersListTabletPageState
    extends State<SalesOfficerDealerOrdersListTabletPage> {
  @override
