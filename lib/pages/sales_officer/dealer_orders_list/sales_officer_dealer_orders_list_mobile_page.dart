...
class SalesOfficerDealerOrdersListMobilePage extends StatefulWidget {
  final String dealerUID;
  const SalesOfficerDealerOrdersListMobilePage(
      {Key? key, required this.dealerUID})
      : super(key: key);

  @override
  State<SalesOfficerDealerOrdersListMobilePage> createState() =>
      _SalesOfficerDealerOrdersListMobilePageState();
}

class _SalesOfficerDealerOrdersListMobilePageState
    extends State<SalesOfficerDealerOrdersListMobilePage> {
  @override
