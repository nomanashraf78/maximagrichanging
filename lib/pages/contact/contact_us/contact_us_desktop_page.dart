...
class ContactUsDesktopPage extends StatefulWidget {
  final Widget pageDrawer;
  const ContactUsDesktopPage({Key? key, required this.pageDrawer})
      : super(key: key);

  @override
  State<ContactUsDesktopPage> createState() => _ContactUsDesktopPageState();
}

class _ContactUsDesktopPageState extends State<ContactUsDesktopPage> {
  String aboutUs =
